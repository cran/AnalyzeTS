...
if(frequency(ts)!=1) stop("The 'ts' must be a time series with frequency == 1!")
...
if(hs.hoiqui[2]>=0)
text.hoiqui<-paste("Xu the: Y =",hs.hoiqui[1],"+",paste(hs.hoiqui[2],"*t",sep=""))
if(hs.hoiqui[2]<0)
text.hoiqui<-paste("Xu the: Y =",hs.hoiqui[1],paste(hs.hoiqui[2],"*t",sep=""))
...
text.luythua<-paste("Luy thua: Y =",paste("exp(",hs.luythua[1],")*t^",hs.luythua[2],sep=""))
...
if(hs.luonggiac[2]>=0)
text.luonggiac<-paste("Luong giac: Y =",hs.luonggiac[1],"+",paste(hs.luonggiac[2],"*sin(t)",sep=""))
if(hs.luonggiac[2]<0)
text.luonggiac<-paste("Luong giac: Y =",hs.luonggiac[1],paste(hs.luonggiac[2],"*sin(t)",sep=""))

if(hs.luonggiac[3]>=0)
text.luonggiac<-paste(text.luonggiac,"+",paste(hs.luonggiac[3],"*cos(t)",sep=""))
if(hs.luonggiac[3]<0)
text.luonggiac<-paste(text.luonggiac,paste(hs.luonggiac[3],"*cos(t)",sep=""))
...
if(hs.hyperbol[2]>=0)
text.hyperbol<-paste("Hyperbol: Y =",hs.hyperbol[1],"+",paste(hs.hyperbol[2],"/t",sep=""))
if(hs.hyperbol[2]<0)
text.hyperbol<-paste("Hyperbol: Y =",hs.hyperbol[1],paste(hs.hyperbol[2],"/t",sep=""))
...
if(mh.cscong>=0)
text.cscong<-paste("CS cong: Y = ",ts[n],"*[1 + ",round(mh.cscong,4),"*(t -",t[n],")]",sep="")
if(mh.cscong<0)
text.cscong<-paste("CS cong: Y = ",ts[n],"*[1 ",round(mh.cscong,4),"*(t -",t[n],")]",sep="")
...
if(mh.csnhan>=0)
text.csnhan<-paste("CS nhan: Y = ",ts[n],"*(1 + ",round(mh.csnhan,4),")^(t-",t[n],")",sep="")
if(mh.cscong<0)
text.csnhan<-paste("CS nhan: Y = ",ts[n],"*(1 ",round(mh.csnhan,4),")^(t -",t[n],")",sep="")
